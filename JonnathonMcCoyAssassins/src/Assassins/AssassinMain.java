 ...
 * 06/07/2016
 * 
 * A game that mimics the college game assassins.  Each person gets an assigned person
 * to stalk.  When they kill their mark, he/she gets removed from the game.
 */

// Instructor-provided testing program. Created by Marty Stepp

package Assassins;  // modified: Jonnathon McCoy
...
public class AssassinMain 
{
     ...
     * @throws FileNotFoundException Exception not handled within this class.
     */
     ...
     * 
     * @param console Pass on input from user.
     * @param manager Assassin Manager Class that handles the Linked Lists
     */
